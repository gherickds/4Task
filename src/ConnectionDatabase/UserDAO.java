...
public class UserDAO extends BaseDAO{
     ...
     */
        ...
        public User getById(long id){
            ...
            try(
                    Connection connection = getConnection();
                    PreparedStatement statement = connection.prepareStatement("select user_id,name,password,user_email from user where user_id = ?")
            ){
        ...
        public User getByName(String name){
            ...
            try(
                    Connection connection = getConnection();
                    PreparedStatement statement = connection.prepareStatement("select user_id,name,password,user_email from user where name = ?")
            ){
                // Informa o user_id na query
